...
**DIGITAL APPLICATION SOLUTIONS SL** es el **RESPONSABLE** del tratamiento de los datos personales del **USUARIO** y le informa de que estos datos serán tratados de conformidad con lo dispuesto en el Reglamento (UE) 2016/679, de 27 de abril (RGPD), y la Ley Orgánica 3/2018, de 5 de diciembre (LOPDGDD).
...
- Derecho a presentar una reclamación ante la autoridad de control ([www.aepd.es](https://www.aepd.es)) si considera que el tratamiento no se ajusta a la normativa vigente.

**Datos de contacto para ejercer sus derechos:** DIGITAL APPLICATION SOLUTIONS SL. CALLE PI I MARGALL, 10 Esc. A Baix 2a - 43007 Tarragona. E-mail: [support@dastions.com](mailto:support@dastions.com).

**Datos de contacto del delegado de protección de datos:** DATA GESTIÓ, Carrer Bonaventura Hernandez i Sanahuja 2-4-6, 43002 Tarragona — [info@datagestio.es](mailto:info@datagestio.es).
...
Para más información sobre las garantías de privacidad, puedes dirigirte al **RESPONSABLE** a través de DIGITAL APPLICATION SOLUTIONS SL. CALLE PI I MARGALL, 10 Esc. A Baix 2a - 43007 Tarragona. E-mail: [support@dastions.com](mailto:support@dastions.com).
